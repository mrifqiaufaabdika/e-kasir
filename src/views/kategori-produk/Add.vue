        ...
        >
            <v-row>
                ...
                >
                    ...
                    >
                        <div>
                            <v-text-field v-model="datas.nama_kategori_produk" label="Nama Kategori" outlined :rules="[rules.required]" />
                            <v-btn
                                    color="green"
                                    large
                                    :dark="!dataValidation"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapActions(['addKategoriProduk']),
            backButton () {
                this.$router.push({ name: 'kategori-produk' })
            },
            postSave () {
                ...
                this.addKategoriProduk(formData).then((res) => {
