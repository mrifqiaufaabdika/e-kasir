...
export default {
  ...
  computed: {
    headerData () {
      return [
        { text: 'Id', value: 'id' },
        { text: 'Nama Pramudi', value: 'nama_pramudi' },
  ...
  methods: {
    ...mapActions(['getPramudi', 'deletePramudi']),
    can,
    _detail (value) {
      this.$router.push({ name: 'pramudi_view', params: { id: value.id } })
    },
    _add () {
      this.$router.push({ name: 'pramudi_add' })
    },
    _edit (value) {
      this.$router.push({ name: 'pramudi_edit', params: { id: value.id } })
    },
    _delete (value) {
      if (value === true) {
        ...
        this.dcMessages = 'Sedang Menghapus Pramudi'
        this.deletePramudi(this.deleteId).then(res => {
          this._loadData(true)
