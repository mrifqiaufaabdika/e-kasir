...
export default {
  ...
  computed: {
    headerData () {
      return [
        { text: 'Id', value: 'id' },
        { text: 'Kode Rute', value: 'kode_rute' },
        { text: 'Nama Rute', value: 'nama_rute' },
        { text: 'Id Halte Awal', value: 'id_halte_awal' },
        { text: 'Id Halte Akhir', value: 'id_halte_akhir' },
  ...
  methods: {
    ...mapActions(['getRute', 'deleteRute']),
    can,
    _detail (value) {
      this.$router.push({ name: 'rute_view', params: { id: value.id } })
    },
    _add () {
      this.$router.push({ name: 'rute_add' })
    },
    _edit (value) {
      this.$router.push({ name: 'rute_edit', params: { id: value.id } })
    },
    _delete (value) {
      if (value === true) {
        ...
        this.dcMessages = 'Sedang Menghapus Rute'
        this.deleteRute(this.deleteId).then(res => {
          this._loadData(true)
