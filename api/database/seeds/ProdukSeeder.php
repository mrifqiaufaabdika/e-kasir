...
class ProdukSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $produk_collection = [
            ...
            ['id_produk'=>'P03','nama_produk'=>'Cucian Mobil Kecil', 'id_kategori_produk'=>'KP03', 'harga'=>'45000','kesediaan'=>'tersedia','satuan'=>'SP05','deskripsi'=>'Cuci Salju Mobil Kecil','status'=>'aktif','stok'=>'100','type_bisnis'=>'coffeshop'],
            ['id_produk'=>'P04','nama_produk'=>'Cucian Mobil Besar', 'id_kategori_produk'=>'KP03', 'harga'=>'50000','kesediaan'=>'tersedia','satuan'=>'SP05','deskripsi'=>'Cuci Salju Mobil Besar','status'=>'aktif','stok'=>'100','type_bisnis'=>'coffeshop'],
