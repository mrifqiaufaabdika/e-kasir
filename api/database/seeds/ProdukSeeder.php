...
class ProdukSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //
        $produk_collection = [
            ['id_produk'=>'P01','nama_produk'=>'Hot Coffe Milk', 'id_kategori_produk'=>'KP01', 'harga'=>'20000','kesediaan'=>'tersedia','satuan'=>'S05','deskripsi'=>'Kopi nikmat 120 cc','status'=>'Aktif','stok'=>'120','foto'=>null,'type_bisnis'=>'2'],
            ['id_produk'=>'P02','nama_produk'=>'Hot Coffe Latte', 'id_kategori_produk'=>'KP01', 'harga'=>'25000','kesediaan'=>'tersedia','satuan'=>'S05','deskripsi'=>'Kopi nikmat 120 cc','status'=>'Aktif','stok'=>'100','foto'=>null,'type_bisnis'=>'2'],


            ['id_produk'=>'P03','nama_produk'=>'Cucian Mobil Kecil', 'id_kategori_produk'=>'KP03', 'harga'=>'45000','kesediaan'=>'tersedia','satuan'=>'S05','deskripsi'=>'Cuci Salju Mobil Kecil','status'=>'Aktif','stok'=>'100','foto'=>null,'type_bisnis'=>'1'],
            ['id_produk'=>'P04','nama_produk'=>'Cucian Mobil Besar', 'id_kategori_produk'=>'KP03', 'harga'=>'50000','kesediaan'=>'tersedia','satuan'=>'S05','deskripsi'=>'Cuci Salju Mobil Besar','status'=>'Aktif','stok'=>'100','foto'=>null,'type_bisnis'=>'1'],
