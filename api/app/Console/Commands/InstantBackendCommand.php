...
class InstantBackendCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'instant:backend';
     ...
     * @var string
     */
    protected $description = 'Instant the backend complete routes, controller and model by tables';
