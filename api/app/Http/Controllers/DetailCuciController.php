...
use App\Models\DetailCuci;
use Illuminate\Http\Request;

class DetailCuciController extends Controller {

    public $title = 'DetailCuci';
    ...
    {
        $data = DetailCuci::search($request,new DetailCuci());
